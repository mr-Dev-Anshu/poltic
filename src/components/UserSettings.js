                ...
                <div className="flex-1 overflow-y-scroll custom-scrollbar ml-0 md:ml-[227px] pt-6 px-5">
                    ...
                    <div className="flex gap-10">
                        ...
                        <div className="sm:mx-4 font-inter">
                            ...
                            <div className=" flex ">
                                <div className="p-4 lg:p-10 flex flex-col items-center justify-center border border-r-0 border-[#9C9C9C] rounded-s-[16px]">
                                ...
                                <hr />
                                <div className="border border-[#9C9C9C] rounded-e-[16px] p-5">
                                    <div className="flex gap-5">
                                        <p className="pt-2 text-[#1C1C1C] text-[20px] ">Basic Information</p>
                                        <FaRegEdit className="mt-3.5 text-blue-600" />
                                    </div>
                                    <div className="grid grid-cols-2 gap-x-20 md:12 lg:mr-20">
                                        <div className="py-4">
                            ...
                            <div className="my-5 p-5 border border-[#9C9C9C] rounded-[16px]">
                                ...
                                <div className="grid grid-cols-3 gap-x-20 md:mr-12 lg:mr-20 pl-2">
                                    <div className="py-4">
